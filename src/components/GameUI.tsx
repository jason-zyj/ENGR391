...
export default function GameUI() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white font-semibold">
              {gameState.player.name || 'Trust Quest'}
            </div>
          </div>

          <div className={`flex items-center gap-2 ${emotionColors[gameState.player.emotionState] || 'text-gray-400'}`}>
            <Heart className="w-5 h-5" />
            <span className="text-white text-sm capitalize">{gameState.player.emotionState}</span>
          </div>
      ...
      {showStats && (
        <div className="fixed top-16 right-4 z-50 bg-white rounded-xl shadow-2xl p-6 w-80 max-h-[calc(100vh-5rem)] overflow-y-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 rounded-xl hover:shadow-lg transition-all"
              >
                Continue Playing
              </button>
